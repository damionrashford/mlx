...
<Note>
  For built-in commands like `/help` and `/compact`, see the [built-in commands reference](https://code.claude.com/docs/en/commands).
...
| `hooks`                    | No          | Hooks scoped to this skill's lifecycle. See [Hooks in skills and agents](hooks-ref.md#hooks-in-skills-and-agents) for configuration format.                                                                 |
...
- **[Hooks](hooks-ref.md)**: automate workflows around tool events
