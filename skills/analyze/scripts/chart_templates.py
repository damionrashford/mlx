...
Usage:
    uv run chart_templates.py data.csv --type bar --x category --y value -o bar_chart.png
    uv run chart_templates.py data.csv --type line --x date --y value --hue segment -o trend.png
    uv run chart_templates.py data.csv --type hist --x value -o distribution.png
    uv run chart_templates.py data.csv --type heatmap -o correlations.png
    uv run chart_templates.py data.csv --type scatter --x feature_a --y target -o scatter.png
    uv run chart_templates.py data.csv --type box --x group --y value -o box.png
"""
